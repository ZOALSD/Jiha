            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- <video class="vjs-theme-fantasy video-js hidden" id="video{{ $random }}"
                            data-setup='{"controls": true, "autoplay": false, "preload": "auto"}' width="762px"
                        ...
                        <video controls
                            ...
                            <a href="{{ it()->url($video) }}" target="_blank" class="float-left"><i
