<button type="button" class="btn btn-info">
	<a href="{{ aurl('/generals/'.$id.'/edit')}}"><i class="fas fa-edit"></i> {{trans('admin.edit')}}</a>
</button>
 ...
 {{-- <div class="btn-group">
	...
	<div class="dropdown-menu" role="menu">
		<a href="{{ aurl('/generals/'.$id.'/edit')}}" class="dropdown-item" ><i class="fas fa-edit"></i> {{trans('admin.edit')}}</a>
