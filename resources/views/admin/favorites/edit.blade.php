	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('favorites/'.$favorites->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/favorites/'.$favorites->id),'method'=>'put','id'=>'favorites','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('pro_id',trans('admin.pro_id'),['class'=>'control-label']) !!}
        {!! Form::text('pro_id', $favorites->pro_id ,['class'=>'form-control','placeholder'=>trans('admin.pro_id')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('user_id',trans('admin.user_id'),['class'=>'control-label']) !!}
        {!! Form::text('user_id', $favorites->user_id ,['class'=>'form-control','placeholder'=>trans('admin.user_id')]) !!}
    </div>
</div>
