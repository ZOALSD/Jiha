	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('servicesus/'.$servicesus->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/servicesus/'.$servicesus->id),'method'=>'put','id'=>'servicesus','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
		<div class="form-group">
				{!! Form::label('user_id',trans('admin.user_id'),['class'=>'control-label']) !!}
{!! Form::select('user_id',App\Models\User::pluck('first_name','id'), $servicesus->user_id ,['class'=>'form-control select2','placeholder'=>trans('admin.user_id')]) !!}
		</div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
		<div class="form-group">
				{!! Form::label('services_type_id',trans('admin.services_type_id'),['class'=>'control-label']) !!}
{!! Form::select('services_type_id',App\Models\Servicetype::pluck('name','id'), $servicesus->services_type_id ,['class'=>'form-control select2','placeholder'=>trans('admin.services_type_id')]) !!}
		</div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
